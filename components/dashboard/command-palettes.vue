          ...
          >
            <Combobox @update:modelValue="onSelect">
              <div class="relative">
                ...
                />
                <ComboboxInput
                  class="h-12 w-full bg-transparent pl-11 pr-4 text-gray-900 placeholder:text-gray-400 box-border rounded-t-xl focus:ring-0 focus-visible:outline-indigo-600 sm:text-sm"
                  placeholder="Search..."
                  ...
                  <ul class="text-sm text-gray-700">
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          v-if="active"
                          class="ml-3 flex-none text-indigo-100"
                          >Jump to...</span
                        >
                      </li>
                    </ComboboxOption>
...
const open_model = defineModel("open");
const projects = [
